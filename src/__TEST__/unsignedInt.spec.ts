...
describe(`UnsignedInt`, () => {
    ...
    describe(`zero`, () => {
      describe(`as int`, () => {
        ...
        it(`parseLiteral`, () => {
          expect(
            // @ts-ignore
            UnsignedInt.parseLiteral({ value: 0, kind: Kind.INT }, {})
          ).toBe(0)
        })
      })
  ...
  describe(`invalid`, () => {
    ...
    describe(`undefined`, () => {
      it(`serialize`, () => {
        // @ts-ignore
        expect(() => UnsignedInt.serialize()).toThrow(/Value is not a number/)
      })

      it(`parseValue`, () => {
        // @ts-ignore
        expect(() => UnsignedInt.parseValue()).toThrow(/Value is not a number/)
      })

      it(`parseLiteral`, () => {
        // @ts-ignore
        expect(() => UnsignedInt.parseLiteral({ kind: Kind.INT }, {})).toThrow(
          /Value is not a number/
        )
      })
    })
    ...
    describe(`unsafe integer`, () => {
      ...
      it(`parseLiteral`, () => {
        expect(() =>
          // @ts-ignore
          UnsignedInt.parseLiteral({ value: 2 ** 53, kind: Kind.INT }, {})
        ).toThrow(/Value is not a number/)
      })
    })
    ...
    describe(`NaN`, () => {
      ...
      it(`parseLiteral`, () => {
        expect(() =>
          // @ts-ignore
          UnsignedInt.parseLiteral({ value: Number.NaN, kind: Kind.STRING }, {})
        ).toThrow(
          /Can only validate integers as non-negative integers but got a/
        )
      })
