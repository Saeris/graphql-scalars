...
describe(`NonPositiveInt`, () => {
  describe(`valid`, () => {
    describe(`as int`, () => {
      ...
      it(`parseLiteral`, () => {
        expect(NonPositiveInt.parseLiteral({ value: -123, kind: Kind.INT })).toBe(-123)
      })
    })
    ...
    describe(`zero`, () => {
      describe(`as int`, () => {
        ...
        it(`parseLiteral`, () => {
          expect(NonPositiveInt.parseLiteral({ value: 0, kind: Kind.INT })).toBe(0)
        })
      })
  ...
  describe(`invalid`, () => {
    describe(`null`, () => {
      it(`serialize`, () => {
        expect(() => NonPositiveInt.serialize(null)).toThrow(/Value is not a number/)
      })

      it(`parseValue`, () => {
        expect(() => NonPositiveInt.parseValue(null)).toThrow(/Value is not a number/)
      })

      it(`parseLiteral`, () => {
        expect(() => NonPositiveInt.parseLiteral({ value: null, kind: Kind.INT })).toThrow(/Value is not a number/)
      })
    })
    ...
    describe(`more than zero`, () => {
      describe(`as int`, () => {
        it(`serialize`, () => {
          expect(() => NonPositiveInt.serialize(1)).toThrow(/Value is not a non-positive number/)
        })

        it(`parseValue`, () => {
          expect(() => NonPositiveInt.parseValue(1)).toThrow(/Value is not a non-positive number/)
        })

        it(`parseLiteral`, () => {
          expect(() => NonPositiveInt.parseLiteral({ value: 1, kind: Kind.INT })).toThrow(
    ...
    describe(`infinity`, () => {
      it(`serialize`, () => {
        expect(() => NonPositiveInt.serialize(Number.NEGATIVE_INFINITY)).toThrow(/Value is not a finite number/)
      })

      it(`parseValue`, () => {
        expect(() => NonPositiveInt.parseValue(Number.NEGATIVE_INFINITY)).toThrow(/Value is not a finite number/)
      })
    ...
    describe(`not a number`, () => {
      it(`serialize`, () => {
        expect(() => NonPositiveInt.serialize(`not a number`)).toThrow(/Value is not a number/)
      })

      it(`parseValue`, () => {
        expect(() => NonPositiveInt.parseValue(`not a number`)).toThrow(/Value is not a number/)
      })
