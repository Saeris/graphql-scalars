...
describe(`GUID`, () => {
  describe(`valid`, () => {
    it(`serialize`, () => {
      expect(GUID.serialize(`123e4567-e89b-12d3-a456-426655440000`)).toEqual(
        `123e4567-e89b-12d3-a456-426655440000`
      )
    })

    it(`parseValue`, () => {
      expect(GUID.parseValue(`123e4567-e89b-12d3-a456-426655440000`)).toEqual(
        `123e4567-e89b-12d3-a456-426655440000`
      )
    })
  ...
  describe(`invalid`, () => {
    describe(`not a valid GUID`, () => {
      ...
      it(`parseLiteral`, () => {
        expect(() =>
          // @ts-ignore
          GUID.parseLiteral({ value: 123, kind: Kind.INT }, {})
