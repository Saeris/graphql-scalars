...
describe(`Hexadecimal`, () => {
  describe(`valid`, () => {
    it(`serialize`, () => {
      expect(Hexadecimal.serialize(`123456789AbCdEf`)).toEqual(
        `123456789AbCdEf`
      )
    })

    it(`parseValue`, () => {
      expect(Hexadecimal.parseValue(`123456789AbCdEf`)).toEqual(
        `123456789AbCdEf`
      )
    })
  ...
  describe(`invalid`, () => {
    describe(`not a valid hexadecimal value`, () => {
      it(`serialize`, () => {
        ...
        expect(() =>
          Hexadecimal.serialize(`this is not a hex color code`)
      ...
      it(`parseValue`, () => {
        expect(() => Hexadecimal.serialize(123)).toThrow(/Value is not string/)
        expect(() =>
          Hexadecimal.parseValue(`this is not a hex color code`)
        ).toThrow(/Value is not a valid hexadecimal value/)
      })
      ...
      it(`parseLiteral`, () => {
        expect(() =>
          // @ts-ignore
          Hexadecimal.parseLiteral({ value: 123, kind: Kind.INT }, {})
